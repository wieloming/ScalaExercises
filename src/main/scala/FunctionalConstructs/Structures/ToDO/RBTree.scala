//package FunctionalConstructs.Structures.ToDO
//
//object RedBlack {
//  def makeBlack[K : Ordering, V](tree: Tree[K, V]) = tree match {
//    case Node(false, left, key, value, right) => Node(isBlack = true, left, key, value, right)
//    case t => t
//  }
//
...
//        Node(isBlack = false, Node(true, a, xk, xv, b), yk, yv, Node(true, c, zk, zv, d))
//
